...
| Env-3       | 3.4.x - 3.5.x  | Previous    | Upgrade scenarios             |
...
| **Test Steps**        | <ol><li>Configure cluster for Kubernetes Native Mode</li><li>Install external Argo Workflows</li><li>Disable DSP WorkflowControllers globally</li><li>Create DSPA and execute pipelines</li><li>Verify Kubernetes native execution with external Argo</li></ol> |
...
### <ol><li>6 Sub-Component Removal Testing
