# Test Plan: KFP MLMD Removal and OneOf Implementation
...
### Phase 4: Integration and Security (Week 6-7)
...
**Strategy**:
- Run all storage layer tests (`artifact_store_test.go`, `task_store_test.go`, `artifact_task_store_test.go`)
- Run resolver tests (`parameters_test.go`, `artifacts_test.go`)
- Execute driver unit tests (`dag_test.go`, `container_test.go`)
- Verify API converter tests
...
#### Phase 5: Performance and Migration (Week 8)
