...
type V2beta1Run struct {
	...
	// Read Only: true
	PipelineReference *V2beta1PipelineVersionReference `json:"pipeline_reference,omitempty"`
...
func (m *V2beta1Run) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePipelineReference(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V2beta1Run) contextValidatePipelineReference(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V2beta1Run) contextValidateTasks(ctx context.Context, formats strfmt.Registry) error {
